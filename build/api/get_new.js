...
export function startNewGame(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, w, h, width, height, newGame, gameId, payload, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    newGame = generateNewGameState({ width: width, height: height });
                    gameId = uuid();
                    payload = __assign(__assign({}, newGame), { gameId: gameId });
                    // let the catch handle the error first
                    return [4 /*yield*/, getRedisInstance().set(gameId, JSON.stringify(payload))];
                case 1:
                    // let the catch handle the error first
                    _b.sent();
